...
- Plain log and speaker-segment log editors with speaker-line metrics, segment search, segment split/duplication, merge, timing normalization, review filters, and visible segment JSON export.
...
- Dynamic next-session prep notes from approved campaign memory, with prep-note and full-session Markdown export from the prep view or session list.
...
- Local autosave, campaign/library/session JSON export/import, session duplication, and API key storage outside campaign exports.
