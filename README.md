...
- Plain log and speaker-segment log editors with speaker-line metrics, segment split/duplication, merge, timing normalization, review filters, and visible segment JSON export.
- Multiple local campaigns with full session/detail search, switching, creation, duplication, deletion, and whole-library JSON backup.
...
- Dynamic next-session prep notes from approved campaign memory, with prep-note and full-session Markdown export.
