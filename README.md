...
- Local autosave with storage-size visibility, campaign/library/session JSON export/import, raw session JSON import, session duplication, and API key storage outside campaign exports.
